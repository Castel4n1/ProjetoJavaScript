...
document.getElementById("sliding-header-menu-outer").onclick = function () {  
...
for (var a = 0; a < about_tags.length; a++) {
  ...
  about_tags[a].onclick = function () {  
    ...
    for (var b = 0; b < about_tags.length; b++) {
      ...
      about_tags[b].style['font-weight'] = unselected_color;      
    }
...
document.getElementById("service-next").onclick = function (){
  ...
  if(servico_atual == 0){
    var servico_seguinte = our_services.length -1;
  }else{
